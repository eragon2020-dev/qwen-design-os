...
Before entering overdrive, ensure you have design context for the project. Check `.impeccable.md` in the project root or the loaded instructions for a **Design Context** section. If no design context exists, run `/teach-impeccable` first.
