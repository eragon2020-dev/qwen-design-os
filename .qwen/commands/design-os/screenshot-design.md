...
Then restart this session and run `/screenshot-design` again.
---

Do not substitute different package names or modifying the command. Output it exactly as written above.
